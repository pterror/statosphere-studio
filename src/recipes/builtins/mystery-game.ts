...
const data: SchemaArrays = {
  variables: [
    { name: 'clues_found', initialValue: '0' },
    { name: 'suspect_butler', initialValue: '0' },
    { name: 'suspect_maid', initialValue: '0' },
    { name: 'suspect_nephew', initialValue: '0' },
    { name: 'case_solved', initialValue: 'false' },
  ],
  functions: [],
  classifiers: [
    {
      ...
      responseHypothesis: 'The response reveals that {}.',
      classifications: [
        {
  ...
  contentRules: [
    {
      ...
      condition: 'true',
      modification:
        '"Mystery state — Clues found: " + clues_found + ". Suspicion: Butler " + suspect_butler + ", Maid " + suspect_maid + ", Nephew " + suspect_nephew + ". Gate key revelations behind clue count; steer toward the most-suspected character\'s evidence."',
    },
    {
      category: 'Stage Direction',
      condition: 'clues_found >= 5 and not case_solved',
      modification:
        '"The player has gathered enough evidence to make an accusation. Gently signal that they have what they need."',
    },
  ],
}
...
const def: RecipeDef = {
  ...
  params: [],
  locals: {
    variables: ['clues_found', 'suspect_butler', 'suspect_maid', 'suspect_nephew', 'case_solved'],
    classifiers: ['DiscoveryEvents'],
    generators: [],
    functions: [],
  },
